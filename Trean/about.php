	...
	<div class="main">
		...
		<div class="testimonial-container">
			<div class="title">
				...
				<p>Great Products Have A Good Reviews
                </p>
            </div>
                <div class="container">
                	<div class="testimonial-item active">
                		<img src="img/01.jpg">
                		<h1>sara smith</h1>
                		<p>Healthy & tasty. Can't wait to order for more!</p>
                	</div>
                	<div class="testimonial-item">
                		<img src="img/02.jpg">
                		<h1>john smith</h1>
                		<p>This helps me to relax and regain healthiness. All my friends and family said so too!</p>
                	</div>
                	<div class="testimonial-item">
                		<img src="img/03.jpg">
                		<h1>selena ansari</h1>
                		<p>My Favorite in the morning! God Bless whoever created this product!</p>
                	</div>
                	<div class="testimonial-item">
                		<img src="img/04.png">
